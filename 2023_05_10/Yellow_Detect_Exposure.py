...
K_VALUE_ADJUST_REAL_DISTANCE = 40   # K值调整测量时的实际距离(cm)
...
# 黄色异物检测
def yellow_Detect(img,yellow_threshold):
...
if __name__ == '__main__':
    ...
    while True:
        ...
        #yellow_Detect(img,(24, 90, -26, 2, 28, 70)) # 顺光曝光值：9864us
        #yellow_Detect(img,(57, 99, -8, 9, 15, 36)) # 逆光曝光值：9864us
