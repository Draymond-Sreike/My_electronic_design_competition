...
def yellow_Detect_1(img,yellow_threshold):
    global distance_average, yellow_led_glitter_mode,first_enter_center_flag_1,first_data_send_flag_1
...
if __name__ == '__main__':
    ...
    while True:
        ...
        yellow_distance_detect_K_adjust((20, 90, -9, 22, 22, 67),K_VALUE_ADJUST_REAL_DISTANCE, img)
